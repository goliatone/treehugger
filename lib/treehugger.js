...
TreeHugger.prototype.fromFile = function(filepath, parser){
    parser = parser || this.fileParser;
    var content = fs.readFileSync(filepath, 'utf-8');
    content = parser(content);
    return this.write(content);
};

// TreeHugger.prototype.use = function(){}

TreeHugger.prototype.write = function(data){
    assert.isObject(data, 'You need to pass in a data object');
    //TODO: _loadedFlag should be called with appname!
    ...
    Object.keys(data).map(function(key){
        ...
        if(this.ENV[name] && ! this.override) return;
...
TreeHugger.prototype._loadedFlag = function(appname){
    //TODO: Fix, when we call this we are passing namespace instead!!
